    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" <%= multiPart ? ' enctype="multipart/form-data"' : '' %>>
                <g:if test="\${${propertyName}.COMPOSITE_KEY == false}">
                    <g:if test="\${${propertyName}.id.class.name == 'String'}">
                        <input type="hidden" name="id" value="\${${propertyName}?.id.trim()}" />
                    </g:if>
                    <g:else>
                ...
                <div class="dialog">
                    <table>
                        <tbody>
                        <%
                            excludedProps = ['version', 'id', 'newEntity', 
                                               Events.ONLOAD_EVENT,
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">
                                ...
                                <g:checkBox name="newEntity" value="\${${propertyName}.newEntity}" disabled="true"/>
                            </td>
                        </tr> 
                        </tbody>
                    </table>
