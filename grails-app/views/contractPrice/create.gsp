...
<html>
    <head>
        ...
        <title>Create ContractPrice</title>         
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:contractPrice,field:'id','errors')}">
                                    <input type="text" id="id" name="id" value="${fieldValue(bean:contractPrice,field:'id')}" />
                                </td>
                            </tr> 
